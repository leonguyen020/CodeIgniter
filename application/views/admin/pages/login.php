  ...
  <div class="login-box-body">
    ...
    <form action="" method="post">
      <div class="form-group has-feedback">
          <input type="email" class="form-control" placeholder="Email" name="admin_email" value="<?php echo set_value('admin_email')?>">
        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
          <input type="password" class="form-control" placeholder="Password" name="admin_pass" value="<?php echo set_value('admin_pass')?>">
...
<!-- jQuery 2.2.0 -->
<script src="<?php echo public_url()?>/admin/plugins/jQuery/jQuery-2.2.0.min.js"></script>
<!-- Bootstrap 3.3.6 -->
